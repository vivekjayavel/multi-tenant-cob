    ...
    <div className="min-h-screen bg-stone-50 flex">
      <aside className="w-56 flex-shrink-0 bg-white border-r border-gray-100 flex flex-col fixed top-0 bottom-0 z-30 hidden md:flex">
        <div className="px-5 py-5 border-b border-gray-50">
          {tenant?.logo_url ? <img src={tenant.logo_url} alt={tenant.name} className="h-7 object-contain" /> : <p className="font-display font-bold text-gray-900 text-sm">{tenant?.name}</p>}
