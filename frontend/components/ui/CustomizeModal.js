  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        style={{ paddingTop: '90px', paddingBottom: 'max(16px, env(safe-area-inset-bottom, 16px))' }}
      ...
      >
        <motion.div
          ...
          className="w-full sm:max-w-md bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col mx-4 sm:mx-0" style={{ maxHeight: 'calc(100dvh - 120px)', marginBottom: 'env(safe-area-inset-bottom, 0px)' }}
        >
          {/* Header */}
            ...
            {opts.message?.enabled && (
              <div>
                ...
                <input
                  ...
                  maxLength={60}
                  className="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 transition-all placeholder-gray-300"
                />
            ...
            {opts.instructions?.enabled && (
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  maxLength={300}
                  className="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 transition-all placeholder-gray-300 resize-none"
                />
            ...
            <div className="flex items-center justify-between pt-1">
              ...
              <div className="flex items-center border border-gray-200 rounded-xl overflow-hidden">
                <button onClick={() => setQty(q => Math.max(1, q - 1))}
                  className="px-4 py-2.5 text-gray-600 hover:bg-gray-50 transition-colors font-medium text-lg">−</button>
                <span className="px-4 py-2.5 text-sm font-bold border-x border-gray-200 min-w-[44px] text-center">{qty}</span>
          ...
          <div className="p-5 border-t border-gray-100 space-y-2">
            ...
            <motion.button
              ...
              className="w-full text-white font-semibold py-4 rounded-2xl transition-all hover:shadow-lg disabled:opacity-50"
