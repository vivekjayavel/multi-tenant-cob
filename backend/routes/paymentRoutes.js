...
router.post('/create-order', authMiddleware, paymentLimiter, body('orderId').isInt({ min: 1 }), validate, ctrl.createRazorpayOrder);
router.post('/verify', authMiddleware, paymentLimiter, [
